...
photopicker使用：
1.在photopicker的AndroidManifest.xml中修改
    <provider
        android:authorities="xx_photoPicker"//修改此处名称保证唯一性
        ..
    >
    </provider>
    以及com.cxp.photopicker.utils.PictureUtils.authority的值
     ...
     @Override
        protected void onActivityResult(int requestCode, int resultCode, Intent data) {
            ...
            if (requestCode == PICK_PHOTO && resultCode == RESULT_OK) {//相册选择图片
                ...
                //TODO 接受多张图片data.getStringArrayList(com.cxp.photopicker.PhotoPickerActivity.KEY_RESULT);
        }